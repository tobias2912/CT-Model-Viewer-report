...
To allow for the virtual enviroment to seem realistic, it must respond to the users actions. Current commercial Virtual Reality headsets tracks the position and rotation of the users head and hands, and allows for button inputs\cite{quest}.

-used for entertainment and professional use

\subsubsection{advantages and disadvangages}
A disadvantage with wearing a HMD is fatigue, both physical fatigue caused by the weight or eye fatigue.
Eye fatigue is caused by image imperfections\cite{visualcomfort}.
