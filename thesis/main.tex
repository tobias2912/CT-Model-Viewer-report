...
%enkelte kommentarer
One participant mentioned that using controllers to manipulate tilt and rotation is easier with VR controllers compared to mouse/keyboard. This is relevant for planning with implants.
...
%TODO: knut sine meninger


%SUS result
The result from the SUS questions was 56 points out of 100. The sample size is too small to conclude anything, but the result can still be a topic of discussion. The questions used and average scores are available in the appendix.


\section{Discussion}
%Final application
TODO: final state of application
TODO: ting som burde endres
...
%SUS synsing
The SUS score of 56 indicates a less than average application usability, which is 68~\cite{system_usability_scale_sus_system_2013}. The low usability score is probably skewed by scepticism towards the use-case and not just the user experience of the application itself. The question \emph{I want to use the application often} had a score of 1/5 because of what tools they already use are sufficient, and not the applications usability. This questions does imply that the application is not very useful.
