...
% \begin{itemize}
% 	\item How can VR give better preparation for surgery?
...
%how medical imaging is used in the workflow
...
%Knut feedback
% Some of the interview results are from the surgeon on the team that was included in the development process. He could be biased on how easy the software is to use or on how useful it is but is still included for the sake of discussion.
