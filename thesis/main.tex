...
Unity has good support for different VR and XR platforms\cite{unityxr} including the OpenR standard widely used by VR headsets\cite{openxr}. This allows to create VR games with Unity handling most of the VR logic.
...
A video game style toturial was considered, where the user would go through tasks with hints or descriptions of the features in the application. However this was not implemented as learning the application was quick in early testing. 
...
Moving the interactable fracure components

The most used part of the interface is moving the fracture parts to inspect them.
