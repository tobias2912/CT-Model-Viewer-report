...
Orthopedic surgeons do both elective (planned) and emergency surgery. In elective surgery, the surgeons will have days or weeks to plan out the surgery. A team of usually two surgeons will plan the surgery together.
...
The different imaging types have different advantages. A CT scan is better for more minor hairline fractures and skull, pelvis, spine fractures. MRI can additionally detect soft tissue and ligament injuries. X-Ray is an older, but simpler and cheaper technique\cite{ebnezar_textbook_2016}.
