...
The goal was to determine if any of the proposed use cases and implemented features were relevant for other end users and if any additional requirements were relevant.
%approach
The intended use cases were described to the participants. At this point, the intended use case was improving the understanding compared to traditional slice visualisation.
...
The model pieces are large and smaller pieces can not be moved individually. Smaller pieces should be movable in order to perform the reduction.
...
Between the first and second test the application was improved based on the previous results. A similar fracture to the first test was split up into much smaller individual pieces to allow for movement. Other miscellaneous changes were added to improve the user experience.
